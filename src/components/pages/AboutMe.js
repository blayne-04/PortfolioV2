...
export default function AboutMe(){
  return(
    <div className = 'row'>
      <img src = {profilePic} alt = 'Blayne Fuller' className = 'col-md-6 col-sm-12'/>
          <p className = 'col-md-6 aboutMeP'>Hi, I'm Blayne Fuller, I'm an 18 year old recent high school graduate and a full stack web developer,
